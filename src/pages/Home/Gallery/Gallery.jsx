...
const Gallery = () => {
  ...
  return (
    <div data-aos="zoom-in" className="mt-32 mb-16">
      ...
      <div className="max-w-3xl lg:max-w-4xl  mx-auto  rounded-md ">
      <FastMarquee  direction="left" speed={40} gradient={false}>
            <div className="bg-white  rounded-lg w-48 sm:w-56 md:w-64 lg:w-72">
            <img
        ...
        <FastMarquee  direction="left" speed={40} gradient={false}>
          ...
          <div className="bg-white  rounded-lg w-48 sm:w-56 md:w-64 lg:w-72">
            <img
              src="https://themarket.azureedge.net/resizer/view?key=2f9db0da6a8d2b8b58a5144e39763f87&b=productimages&w=1080&h=1080"
              alt=""
            />
          </div>
          <div className="bg-white  rounded-lg w-48 sm:w-56 md:w-64 lg:w-72">
      ...
      <p className="font-Raleway text-xs sm:text-base md:text-xl pt-10 pb-2 leading-relaxed text-center max-w-5xl mx-auto">

    ...
    return (
        <div>
              ...
              <Mission />
                ...
                <div className="grid grid-cols-1 gap-y-5 md:gap-y-0 md:grid-cols-2 mt-48 mb-16 px-20 py-8 shadow-lg rounded-lg items-center">

                    <div className="flex flex-col space-y-3 md:flex-row md:space-y-0  items-center space-x-5">
                    <div className="bg-lime-500 w-fit p-4 md:p-6 text-white text-xl md:text-2xl rounded-full">
                        <FaPaperPlane />
                    </div>
                    <div className=" text-xl md:text-2xl font-Raleway font-semibold w-full">

        ...
        <div className={bgBanner}>
                <div className="w-full h-full flex items-center justify-center ">
                    <div  data-aos="zoom-in" className="flex flex-col bg-white p-12 rounded-lg shadow-md text-center max-w-md mx-auto md:max-w-full">
                        ...
                        <p className="leading-relaxed font-Raleway pt-4 font-bold  max-w-xs md:max-w-xl text-2xl md:text-4xl mx-auto">Whimsical animals for playful imaginations </p>

...
const AllToys = () => {
  ...
  return (
    <div className="mb-32 mt-8 min-h-screen">
      <div className="flex items-center justify-between pt-16">
        ...
        >
          <input
            ...
            value={searchName}
            className="focus:outline-lime-500 outline outline-gray-200 px-3 py-1 rounded-lg"
            type="text"
            placeholder="Search by name"
          />
          <button className="text-xl text-lime-500" type="submit">
            <FaSearch />
          </button>
        </form>
      </div>
      ...
      <button
        className={
          toys.length >= 20 && disappear === true
            ? "px-7 py-3 rounded-lg bg-lime-500 text-white"
            : "hidden"
        }
